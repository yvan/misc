...
@protocol HPReorderTableViewCustomDelegate <UITableViewDelegate>
@optional
 ...
 */
@interface HPReorderTableViewCustom : UITableView

@property (nonatomic, assign) id <HPReorderTableViewCustomDelegate> delegate;
 ...
 **/
@interface HPReorderAndSwipeToDeleteTableViewCustom : HPReorderTableViewCustom
