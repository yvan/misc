var statedata = require('../json/statedailyvalue.json') //5 and 6 for download and uDLoad costs
var fs = require('fs')
var countrycode = ''
var JSONedData = {}
var counter = 0
...
fs.writeFile('json/statedailyvaluefinal.json',JSON.stringify(JSONedData, null, 4),function(err){
	if(err) throw err
